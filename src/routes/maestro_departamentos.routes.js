...
import { createDetalleEmpleado, deleteDetalleEmpleadosById, getDetalleEmpleados } from "../controllers/detalle_empleado";
...
router.post('/detalle-empleados', createDetalleEmpleado);
